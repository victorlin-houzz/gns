...
<div class="um-message-header um-popup-header">
	...
	<div class="um-message-header-right">
		<a href="#" data-confirm_text="<?php esc_attr_e( 'Are you sure to block this user?', 'um-messaging' ); ?>"  class="um-message-blocku um-tip-e" title="<?php esc_attr_e( 'Block user', 'um-messaging' ); ?>" data-other_user="<?php echo $message_to; ?>" data-conversation_id="<?php echo ! empty( $response['conversation_id'] ) ? $response['conversation_id'] : 'new'; ?>"><i class="um-faicon-ban"></i></a>
