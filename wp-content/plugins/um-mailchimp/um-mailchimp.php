...
define( 'um_mailchimp_textdomain', 'um-mailchimp' );

define( 'um_mailchimp_requires', '2.0.1' );

function um_mailchimp_plugins_loaded() {
	$locale = ( get_locale() != '' ) ? get_locale() : 'en_US';
	load_textdomain( um_mailchimp_textdomain, WP_LANG_DIR . '/plugins/' . um_mailchimp_textdomain . '-' . $locale . '.mo' );
    load_plugin_textdomain( um_mailchimp_textdomain, false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
}
