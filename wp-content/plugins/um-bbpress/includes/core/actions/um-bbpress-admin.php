...
function um_bbpress_save_access_metabox( $post_id = false, $post = false ) {
	...
	$um_bbpress_can_topic = ! empty( $_POST['_um_bbpress_can_topic'] ) ? $_POST['_um_bbpress_can_topic'] : array();
	$um_bbpress_can_reply = ! empty( $_POST['_um_bbpress_can_reply'] ) ? $_POST['_um_bbpress_can_reply'] : array();
