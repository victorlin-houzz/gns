...
if ( UM()->Reviews_API()->api()->already_reviewed( um_profile_id() ) ) {
	...
	$post = UM()->Reviews_API()->api()->get_review_detail( um_profile_id(), get_current_user_id() );
	setup_postdata( $post );
		...
		um_fetch_user( get_current_user_id() ); ?>
			...
			<div class="um-reviews-item" data-review_id="<?php echo $post->ID; ?>" data-user_id="<?php echo um_profile_id(); ?>">
				...
				<div class="um-reviews-post review-list">
					...
					<?php if ( UM()->Reviews_API()->api()->is_pending( $post->ID ) ) { ?>
				...
				<div class="um-reviews-post review-form">
					...
					<form class="um-reviews-form" action="" method="post">
						...
						<span class="um-reviews-title"><input type="text" name="title" placeholder="<?php _e('Enter subject...','um-reviews'); ?>" value="<?php echo $post->post_title; ?>" maxlength="60" /></span>
