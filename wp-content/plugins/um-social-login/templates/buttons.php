		...
		<div class="um-field">
			...
			<div class="um-col-alt">
				...
				<div <?php if ( $button_style == 'floated' ) { echo 'style="display:inline"'; } ?> class="<?php if ( $button_style == 'responsive' ) echo $class . ' um-half'; ?>">
					<a href="<?php echo esc_attr( UM()->Social_Login_API()->login_url( $provider ) ); ?>" title="<?php echo esc_attr( $arr['button'] ); ?>"
					   class="um-button um-alt um-button-social um-button-<?php echo $provider; ?>" data-redirect-url="<?php echo esc_url( UM()->Social_Login_API()->get_redirect_url() ); ?>">
					<?php if ( $show_icons ) { ?>
