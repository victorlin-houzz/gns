=== UM Theme ===
Contributors: ultimatemember, cryptex_vinci
...
UM Theme is the perfect theme for your next Ultimate Member project.

== Description ==

UM Theme is the perfect theme for your next Ultimate Member project. Designed and developed by Ultimate Member Core developers, it features a bespoke integration with Ultimate Member itself plus many of the most popular customer facing Ultimate Member extensions. There are several layout & color options to personalize your shop, multiple widget regions, a responsive design and much more. Developers will love its lean and extensible codebase making it a joy to customize and extend. Looking for a Ultimate Member theme? Look no further!

For more information about UM Theme please go to https://ultimatemember.com/

For even more customization, check out UM extensions https://ultimatemember.com/extensions/

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Locate & upload the um-theme.zip from your computer.
...
UM Theme is based on Underscores https://underscores.me/, (C) 2012-2017 Automattic, Inc.
...
UM Theme serves fonts via the hosted Google Fonts service. UM Theme does not share any data with Google directly.
...
* Fix - Header Meta Tags Used Properly for better Accessebility.
