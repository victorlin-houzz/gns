...
<div class="um-form">
		...
		<?php if ( um_is_on_edit_profile() ) : ?><form method="post" action=""><?php endif;?>
		...
		<div class="boot-col-md-3 um-profile-two">
					...
					<?php if ( $args['show_name'] ) { ?>
						<div class="um-name">
							...
							<a href="<?php echo esc_url( um_user_profile_url() ); ?>" title="<?php echo esc_attr( um_user( 'display_name' ) ); ?>">
								<?php echo esc_attr( um_user( 'display_name', 'um-theme' ) ); ?>
							</a>
			...
			<?php do_action( 'um_profile_layout_two' ); ?>
		</div>
