...
if ( ! function_exists( 'is_active_button_border' ) ) {
 function is_active_button_border() {
    ...
    if ( absint( $defaults['um_theme_button_border_enable'] ) === 1 ) {
        return true;
    } else {
        return false;
    }
...
if ( ! function_exists( 'is_active_login_button_border' ) ) {
 function is_active_login_button_border() {
    global $defaults;
    // Check for the slider plugin class.
    if ( absint( $defaults['um_theme_login_button_border_enable'] ) === 1 ) {
        return true;
    } else {
        return false;
    }
...
if ( ! function_exists( 'is_active_reg_button_border' ) ) {
 function is_active_reg_button_border() {
    global $defaults;
    // Check for the slider plugin class.
    if ( absint( $defaults['um_theme_reg_button_border_enable'] ) === 1 ) {
        return true;
    } else {
        return false;
    }
...
if ( ! function_exists( 'is_active_top_bar' ) ) {
 function is_active_top_bar() {
    global $defaults;
    if ( absint( $defaults['um_show_topbar'] ) === 2 || absint( $defaults['um_show_topbar'] ) === 3 ) {
        return true;
    } else {
        return false;
    }
...
if ( ! function_exists( 'is_active_top_bar_two_column' ) ) {
 function is_active_top_bar_two_column() {
    global $defaults;
    if ( absint( $defaults['um_show_topbar'] ) === 3 ) {
        return true;
    } else {
        return false;
    }
...
if ( ! function_exists( 'is_active_column_one_text' ) ) {
 function is_active_column_one_text() {
    global $defaults;
    if ( $defaults['um_show_topbar'] !== 1 && $defaults['um_topbar_colum_first_layout'] === 1 || $defaults['um_topbar_colum_first_layout'] === 2 ) {
        return true;
    } else {
        return false;
    }
...
if ( ! function_exists( 'is_active_topbar_column_two_text' ) ) {
 function is_active_topbar_column_two_text() {
    global $defaults;
    if ( $defaults['um_show_topbar'] === 3 && $defaults['um_topbar_colum_second_layout'] === 1 || $defaults['um_show_topbar'] === 3 && $defaults['um_topbar_colum_second_layout'] === 2 ) {
        return true;
    } else {
        return false;
    }
...
if ( ! function_exists( 'is_active_bottom_column_one_text' ) ) {
 function is_active_bottom_column_one_text() {
    global $defaults;
    if ( absint( $defaults['um_bottombar_colum_first_layout'] ) === 1 ) {
        return true;
    } else {
        return false;
    }
...
if ( ! function_exists( 'is_active_bottom_select_layout_two' ) ) {
 function is_active_bottom_select_layout_two() {
    global $defaults;
    if ( absint( $defaults['um_show_bottombar_layout'] ) === 2 ) {
        return true;
    } else {
        return false;
    }
...
if ( ! function_exists( 'is_active_header_search' ) ) {
    function is_active_header_search() {
        global $defaults;
        if ( absint( $defaults['um_show_header_search'] ) === 1 || absint( $defaults['um_show_header_search'] ) === 2 ) {
            return true;
        } else {
            return false;
        }
...
if ( ! function_exists( 'is_active_bottom_bar' ) ) {
    function is_active_bottom_bar() {
        global $defaults;
        if ( absint( $defaults['um_show_bottombar'] ) === 1 || absint( $defaults['um_show_bottombar'] ) === 3 ) {
            return true;
        } else {
            return false;
        }
...
if ( ! function_exists( 'is_active_bottom_bar_layout_one' ) ) {
    function is_active_bottom_bar_layout_one() {
        global $defaults;
        if ( absint( $defaults['um_show_bottombar_layout'] ) === 1 ) {
            return true;
        } else {
            return false;
        }
...
if ( ! function_exists( 'is_active_header_logo_type_text' ) ) {
    function is_active_header_logo_type_text() {
        global $defaults;
        if ( absint( $defaults['um_show_header_logo_type'] ) === 1 ) {
            return true;
        }
    }
}
...
if ( ! function_exists( 'is_active_header_logo_type_image_logo' ) ) {
    function is_active_header_logo_type_image_logo() {
        global $defaults;
        if ( $defaults['um_show_header_logo_type'] !== 1 ) {
            return true;
        }
    }
}
...
if ( ! function_exists( 'is_active_footer_column_one_text' ) ) {
    function is_active_footer_column_one_text() {
        global $defaults;
        if ( absint( $defaults['um_footer_colum_first_layout'] ) === 1 ) {
            return true;
        } else {
            return false;
        }
...
if ( ! function_exists( 'is_active_footer_column_two_text' ) ) {
    function is_active_footer_column_two_text() {
        global $defaults;
        if ( $defaults['um_show_footer_layout'] === 2 && $defaults['um_footer_colum_second_layout'] === 1 ) {
            return true;
        } else {
            return false;
        }
...
if ( ! function_exists( 'is_active_footer_column_two' ) ) {
    function is_active_footer_column_two() {
        global $defaults;
         if ( $defaults['um_show_footer_layout'] === 2 ) {
            return true;
        } else {
            return false;
        }
...
if ( ! function_exists( 'is_active_header_logged_button_one' ) ) {
    function is_active_header_logged_button_one() {
        global $defaults;
        if ( $defaults['header_logged_out_display'] === 1 || $defaults['header_logged_out_display'] === 2 ) {
            return true;
        } else {
            return false;
        }
...
if ( ! function_exists( 'is_active_header_logged_button_two' ) ) {
 function is_active_header_logged_button_two() {
    global $defaults;
    if ( $defaults['header_logged_out_display'] === 1 || $defaults['header_logged_out_display'] === 3 ) {
        return true;
    } else {
        return false;
    }
...
if ( ! function_exists( 'is_active_header_logged_out_text' ) ) {
 function is_active_header_logged_out_text() {
    global $defaults;
    if ( absint( $defaults['header_logged_out_display'] ) === 4 ) {
        return true;
    } else {
        return false;
    }
